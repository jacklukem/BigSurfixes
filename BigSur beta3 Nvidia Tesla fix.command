...
printf "$'\e[40m'BigSur beta 3 Nvidia Geforce Tesla prelinkedkernel fix by jackluke"

printf "\n\n\n"

clear && printf '\e[3J'
echo "Welcome to the BigSur beta 3 Nvidia Geforce Tesla prelinkedkernel Nvidia GeForce Tesla, Sound, Wifi\nthis version does include telemetry fix, legacy usb fixes"
...
curl https://github.com/jacklukem/BigSurfixes/blob/master/patched%20prelinkedkernel/prelinkedkernelb3nvidiatesla.zip?raw=true --progress-bar -L -o /private/tmp/prelinkedkernel.zip
