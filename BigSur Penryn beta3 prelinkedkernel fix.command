...
printf "$'\e[40m'BigSur beta 3 Penryn prelinkedkernel fix by jackluke"

printf "\n\n\n"

clear && printf '\e[3J'
echo "Welcome to the BigSur beta 3 Penryn prelinkedkernel Sound, Wifi\nthis version does include telemetry fix, legacy usb fixes"
