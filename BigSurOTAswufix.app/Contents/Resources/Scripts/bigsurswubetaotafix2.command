...
echo "\nDone"
sudo mount -uw /
sudo cp -a ~/*/BigSurOTAswufix.app/Contents/Resources/Scripts/SUVMMFaker.dylib /usr/lib/
sudo chown root:wheel /usr/lib/SUVMMFaker.dylib
...
sleep 3
sudo cp -a ~/*/CatalinaOTAswufix.app/Contents/Resources/Scripts/com.apple.softwareupdated.plist /System/Library/LaunchDaemons/
