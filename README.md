...
## *Making a patched BigSur Installer through BaseSystem legacy USB fix updated 11.0.1 release candidate (mainly for non-APFS or legacy USB Penryn Core2Duo and Arrandale MacBookPro) through a stock createinstallmedia or opencore this new version contains many useful patching apps*
