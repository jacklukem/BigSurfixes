...
- the stage3 installer on external USB target is skippable or simply fixable when updating a previous already installed Catalina or BigSur, because it requires an already done apple setup (to fix the apfs firmlinks issues) that is a root account made on APFS Data Volume
