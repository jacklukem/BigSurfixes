...
## *BigSur Installer through BaseSystem legacy USB fix updated release candidate mainly for non-APFS or legacy USB Penryn Core2Duo through a stock createinstallmedia or opencore this new version contains many useful patching apps*
