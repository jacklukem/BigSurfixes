...
[code]diskutil mount Preboot[/code]

Locate your BigSur Data Volume UUID

replace the "prelinkedkernel fix" file in this path:

[code]/Volumes/Preboot/UUID-BigSur/System/Library/CoreServices/[/code]
...
[code]/Volumes/Preboot/UUID-BigSur/System/Library/PrelinkedKernels/[/code]

For the "installer fix" make a BigSur USB Installer with createinstallmedia:

[code]sudo /Applications/Install\ macOS\ Beta.app/Contents/Resources/createinstallmedia --volume /Volumes/BigSurInstaller/[/code]

and replace the "installer fix" file in this path:

[code]/Volumes/USBInstallerBigSur/Library/Preferences/SystemConfiguration/[/code]
...
then from single user mode type : [code]chmod 755 kcsingleuser.sh ; ./kcsingleuser.sh[/code]
...
[code]/System/Volumes/Preboot/[/code]
...
[code]cd / ; mount -uw / ; chmod 755 csrutil2[/code]

[code]./csrutil2 authenticated-root disable[/code]
...
./csrutil2 authenticated-root disable[/code]
